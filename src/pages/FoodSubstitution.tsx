...
const FoodSubstitution = () => {
  ...
  const foodOptions = {
    carbs: ['Arroz Branco cozido', 'Arroz integral cozido', 'Batata inglesa cozida', 'Batata, doce, cozida', 'Macarrão (cozido)', 'Mandioca cozida', 'Mandioquinha', 'Cuscuz de milho cozido', 'Abóbora cabotian cozida', 'Milho, verde, enlatado, drenado', 'Pão francês', 'Tapioca', 'Quinoa cozida', 'Pão de forma tradicional', 'Aveia', 'Farofa pronta - Yoki®', 'Farinha tradicional', 'Pão de forma integral'],
